...
public class ExternalService {
    ...
    public Mono<InstitucionalStaffDto> getInstitutionalStaffById(String staffId) {
        return fetchData("https://vg-ms-institucional-staff-production-9c80.up.railway.app/management/api/v1/institucional-staff/get/", staffId, InstitucionalStaffDto.class);
    }
